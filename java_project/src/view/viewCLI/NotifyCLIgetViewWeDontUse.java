...
public class NotifyCLIgetViewWeDontUse extends CLI {
	private ClI_View view;

	/**
	 * This constructor creates CLI that works with the parameters.
	 * 
	 * @param in
	 *            The inputstream(BufferedReader) that contain all the command
	 *            from the user.
	 * @param out
	 ...
	 */
	public NotifyCLIgetViewWeDontUse(BufferedReader in, PrintStream out,
			HashMap<String, Command> commands, ClI_View view) {
