...
/**
 * The Presenter class implements Observer. sets the Model, View, and a hashmap
 * of eligible commands.
 * 
...
public class Presenter implements Observer {
	...
	/**
	 * A constructor receiving a View and a Model and sets them as his own. Also
	 * it sets the properties XML to be the properties.
	 * 
	 * @param v
	 *            The View object.
	 * @param m
	...
	/**
	 * Disassembling the displaymazeCommand, setting parameters and calling for
	 * the function.
	 */
	...
	/**
	 * Disassembling the solvemazeCommand, setting parameters and calling for
	 * the function.
	 */
	...
	/**
	 * Disassembling the displaysolutionCommand, setting parameters and calling
	 * for the function.
	 */
	...
	/*
	 * checkMotion not work public class checkMotionCommand implements Command{
	 * 
	 * @Override public void doCommand(String arg, PrintStream out) { String[]
	 * data=arg.split(" "); boolean flag = model.checkMotion(data[0],
	 * Integer.parseInt(data[1]), Integer.parseInt(data[2]),
	 * Integer.parseInt(data[3]), Integer.parseInt(data[4]));
	 * System.out.println(flag); view.getData(flag, "checkMotion"); }
	 * 
	 * }
	 */
