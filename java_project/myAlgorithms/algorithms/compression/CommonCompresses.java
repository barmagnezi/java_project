...
/**
* The CommonCompresses class is abstracts.
* All who extend this class need to write the function compress and decompress
*
* @author  Bar Magnezi
* @version 1.0
* @since 3.5.2015
*/
public abstract class CommonCompresses implements Compresses {
	/**
	 ...
	 */
	@Override
	public abstract OutputStream compress(InputStream text);
	/**
	 ...
	 */
	@Override
	public abstract OutputStream decompress(InputStream zipText);
